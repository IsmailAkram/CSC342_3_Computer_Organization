; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30136.0 
	...
	TITLE	C:\Users\Izzy\OneDrive\College\CSC342_3 Computer Organization\Exams\Akram_Take_Home_Final_Take_Home_Test\Intel x86 (VS)\Optimized_Dot_Product\Optimized_Dot_Product\Debug\Source.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$LN17@operator:
	...
	vmovlpd	QWORD PTR __Pad$[ebp], xmm0
...
tv233 = -44						; size = 8
tv224 = -44						; size = 8
_total_time$1$ = -36					; size = 8
_freq$ = -28						; size = 8
_ctr_1$ = -20						; size = 8
_ctr_2$ = -12						; size = 8
__$ArrayPad$ = -4					; size = 4
_main	PROC						; COMDAT
; File C:\Users\Izzy\OneDrive\College\CSC342_3 Computer Organization\Exams\Akram_Take_Home_Final_Take_Home_Test\Intel x86 (VS)\Optimized_Dot_Product\Optimized_Dot_Product\Source.cpp
; Line 14
	push	ebp
	mov	ebp, esp
	...
	mov	ecx, OFFSET __ADB33CF4_Source@cpp
	call	@__CheckForDebuggerJustMyCode@4
	vmovsd	xmm2, QWORD PTR __real@3fe0000000000000
	vmovsd	xmm3, QWORD PTR __real@4008000000000000
	vxorpd	xmm0, xmm0, xmm0
	vmovlpd	QWORD PTR _ctr_1$[ebp], xmm0
	vmovlpd	QWORD PTR _ctr_2$[ebp], xmm0
	vmovlpd	QWORD PTR _freq$[ebp], xmm0
	vmovsd	QWORD PTR _total_time$1$[ebp], xmm0
	xor	eax, eax
$LL4@main:
; Line 20
	...
	vmovss	DWORD PTR ?A@@3PAMA[eax*4], xmm0
; Line 21
	vdivsd	xmm0, xmm1, xmm3
	vcvtsd2ss xmm0, xmm0, xmm0
	vmovss	DWORD PTR ?B@@3PAMA[eax*4], xmm0
	inc	eax
...
; Line 38
	...
	vmovsd	QWORD PTR tv224[ebp], xmm0
	call	__ltod3
	vmovsd	xmm1, QWORD PTR tv224[ebp]
	sub	esp, 8
...
; Line 39
	...
	mov	edx, DWORD PTR _freq$[ebp+4]
	mov	ecx, DWORD PTR _freq$[ebp]
	vmovsd	QWORD PTR tv233[ebp], xmm0
	call	__ltod3
	vmovsd	xmm1, QWORD PTR tv233[ebp]
	vdivsd	xmm0, xmm1, xmm0
	vaddsd	xmm1, xmm0, QWORD PTR _total_time$1$[ebp]
	vmovsd	QWORD PTR _total_time$1$[ebp], xmm1
; Line 41
	jmp	SHORT $LN5@main
$LN8@main:
; Line 44
...
; Line 45
	...
	mov	ecx, eax
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
	vmovsd	xmm1, QWORD PTR _total_time$1$[ebp]
$LN5@main:
; Line 27
	inc	esi
	...
	jl	$LL7@main
; Line 48
	vdivsd	xmm0, xmm1, QWORD PTR __real@4024000000000000
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	sub	esp, 8
	vmovsd	QWORD PTR [esp], xmm0
